    ...
    public partial class vf : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "Name", "PhotoPath", "Price", "PriceDisplay", "VersionId" },
                values: new object[,]
                {
                    { 1, "LUX A2.0", "image/a20.png", 800000000L, "800000000", null },
                    { 2, "LUX SA2.0", "image/sa20.png", 1200000000L, "1200000000", null },
                    { 3, "Fadil", "image/fadil.png", 362000000L, "362000000", null },
                    { 4, "President", "image/president.png", 3800000000L, "3800000000", null }
                });
